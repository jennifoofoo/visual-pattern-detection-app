...
def render_matrix_cell(status: str, tooltip: str, cell_id: str):
    ...
    status_config = {
        "found": {"class": "matrix-cell-success", "symbol": "✓"},
        "not_meaningful": {"class": "matrix-cell-warning", "symbol": "△"},
        "not_found": {"class": "matrix-cell-error", "symbol": "✗"}
    }
    config = status_config.get(status, status_config["not_found"])

    return f"""
    <div class="matrix-cell {config['class']}" data-tooltip="{cell_id}" title="">
        <span class="matrix-symbol">{config['symbol']}</span>
    ...
    <div class="matrix-intro">
        ...
        <div class="matrix-legend">
            <div class="legend-item">
                <span class="legend-symbol legend-success">✓</span>
                <span>Can be found and makes sense</span>
            </div>
            <div class="legend-item">
                <span class="legend-symbol legend-warning">△</span>
                <span>Can be found but doesn't make sense</span>
            </div>
            <div class="legend-item">
                <span class="legend-symbol legend-error">✗</span>

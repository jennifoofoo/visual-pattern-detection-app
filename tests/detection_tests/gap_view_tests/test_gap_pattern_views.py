...
# Add parent directory to path for imports - MUST come before other imports
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '../../..'))
sys.path.insert(0, os.path.dirname(__file__))

from synthetic_gap_logs import (
    make_numeric_y_gap,
...
#         'total_gaps'] >= 1, f"Expected at least 1 gap, got {detector.detected['total_gaps']}"

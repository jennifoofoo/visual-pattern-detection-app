...
EXTENDED_PATTERN_MATRIX: Dict[str, Dict[str, Dict[str, Any]]] = {
    ...
    "relative_ratio_variant": {
        ...
        "temporal_cluster_x": {
            ...
            "makes_sense": False,
            "visual": "N/A",
            "interpretation": "Not meaningful: relative_ratio is not a time measurement, temporal clustering not applicable.",
            "algorithm": "N/A",
            "use_case": "Use actual_time or relative_time for temporal analysis",
            "requirements": [],
            "output": "N/A",
            "x_axis": "relative_ratio",
            "y_axis": "variant"
        ...
        "outlier": {
            ...
            "makes_sense": True,
            "visual": "Red highlighted dots on outlier events",
            "interpretation": "Detects variants with unusual normalized timing patterns or events at abnormal normalized positions for their variant.",
            "algorithm": "IQR-based analysis on normalized timing patterns by variant",
            "use_case": "Finding variants with abnormal structural patterns, comparing event distribution across variants independent of duration",
            "requirements": ["relative_ratio", "variant"],
            "output": "Outlier events with variant-specific normalized position anomalies",
            "x_axis": "relative_ratio",
            "y_axis": "variant"
        }
    }
